...
#' 
#' @details
#' add a df to the microplate object
#' doesnt work!
#' 
#' @param self the MicroPlate object
#' @param df the data.frame to be added
#' 
#' 
...
#' 
#' @param self the microplate object
#' @param newData plate data generated by the microplate reader parsers
#' @param layoutData ...
#' 
...
#' @param newData plate data generated by the microplate reader parsers
#' @param layoutData ...
#' @param plateName the name of the plate, if none is given a number is used
#' @param ... ...
#' 
#' TODO add more plate data...
#' @export
